          ...
          <div className="border-x border-b border-[#E9E9EF] bg-white p-8 md:p-12 lg:p-16 flex flex-col gap-10">
            ...
            <div>
              ...
              <p className="text-[14px] leading-[1.7] text-[#686890]">
                Welcome to Wecollect. By accessing and using our website, you
            ...
            <div>
              ...
              <p className="text-[14px] leading-[1.7] text-[#686890]">
                By using Wecollect's website, you agree to be bound by these
                Terms of Use and any other applicable terms and conditions and
                policies, including our Privacy Policy and Cookie Policy.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-[14px] leading-[1.7] text-[#686890]">
                ...
                Wecollect or its content suppliers and is protected by
                ...
                website without prior written consent from Wecollect.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-[14px] leading-[1.7] text-[#686890]">
                Wecollect will not be liable for any damages of any kind arising
            ...
            <div>
              ...
              <p className="text-[14px] leading-[1.7] text-[#686890]">
                ...
                not owned or controlled by Wecollect. Wecollect has no control
                over, and assumes no responsibility for, the content, privacy
                policies, or practices of any third-party websites. By using
                this website, you expressly relieve Wecollect from any and all
            ...
            <div>
              ...
              <p className="text-[14px] leading-[1.7] text-[#686890]">
                Wecollect reserves the right to modify these terms at any time,
                so please review it frequently. If we make changes to these
                terms, we will post the revised terms here. Your continued use
                of the website after such changes have been posted will
            ...
            <div>
              ...
              <p className="text-[14px] leading-[1.7] text-[#686890]">
                ...
                laws of [Your Country], and you irrevocably submit to the
            ...
            <div>
              ...
              <div className="text-[14px] leading-[1.7] text-[#686890] flex flex-col gap-5">
                <p>
                  ...
                  contact us at hello@Wecollect.tech.
                </p>
                <p>
                  By using Wecollect's website, you acknowledge that you have
