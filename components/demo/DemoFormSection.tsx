      ...
      <Container className="relative z-10">
        <div className="grid md:grid-cols-2">
          ...
          <div className="py-16 md:pr-12 lg:pr-24 lg:py-24 xl:pr-32 flex flex-col justify-center">
            <div className="max-w-110">
              ...
              <p className="text-[#5D5D88] text-[15px] leading-relaxed mb-6">
                Complete the form and our team will get back to you within one
                business day with the right next steps for your needs.
              </p>

              <p className="text-[#5D5D88] text-[15px] leading-relaxed mb-8">
                Prefer a faster conversation? Reach us directly on WhatsApp.
                We're ready to talk.
              </p>
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="text-[16px] font-semibold text-[#0D0D26] mb-1">
                      30-minute session
                    </h4>
                    <p className="text-[13px] text-[#5D5D88]">
                      Live platform walkthrough tailored to your use case
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-[13px] text-[#5D5D88]">
                      Directly with the people who built it
                    </p>
                  </div>
                </div>
          ...
          <div className="py-16 md:pl-12 lg:pl-24 lg:py-24 xl:pl-32 flex flex-col justify-center border-t md:border-t-0 md:border-l border-[#E7E7EF]">
            <form className="max-w-110 w-full" action={action} ref={formRef}>
              <div className="mb-6">
              ...
              <div className="mb-8">
                <label className="block text-[14px] font-semibold text-[#0D0D26] mb-4">
                  Do you have your own field team?{" "}
                  ...
                  <label className="flex items-center gap-2 cursor-pointer group">
                    <div className="relative flex items-center justify-center w-5 h-5">
                      <input
                        type="radio"
                        name="fieldTeam"
                        value="Yes - I have a team"
                        disabled={isPending}
                        className="peer appearance-none w-5 h-5 rounded-full border border-[#C5C5D6] checked:border-[#4B4BDB] cursor-pointer transition-colors"
                      />
              ...
              {state?.error && (
                <p className="text-[#FF5B5B] text-[13px] mt-3 font-medium">
                  {state.error}
                </p>
              )}
              {showSuccess && (
                <p className="text-[#4ade80] text-[13px] mt-3 font-medium">
                  {state?.message}
                </p>
              )}
            </form>
