...
export function VerificationOverview() {
  return (
    <section className="bg-white text-[#0D0D26]">
      <Container>
        <div className="py-16 md:py-20 lg:py-[58px]">
          {/* =========================
              THE PROBLEM
          ========================== */}
          <div>
            ...
            >
              ...
              <div className="grid grid-rows-3">
                <ProblemCard
                  icon={<FraudRiskIcon />}
                  title="Fraud Risk"
                  description="Banks and fintechs lose millions to fraudulent addresses, unverified merchants, and KYC shortcuts."
                />
              ...
              <div className="relative min-h-[360px] md:min-h-0">
                <Image
                  src={VerificationProblemImage}
                  alt="Field agent verifying an address"
                  fill
          ...
          {/* =========================
              KEY FEATURES
          ========================== */}
          <div className="mt-16 md:mt-20 lg:mt-[54px]">
            <p className="text-[9px] font-medium uppercase leading-4 text-[#9898B3]">
              Key Features
            </p>
