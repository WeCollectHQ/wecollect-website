  ...
  return (
    <div className="bg-[#FAFAFD] pt-6 pb-20">
      <Container>
        <Link
          href="/blog"
          className="inline-flex items-center gap-2 text-[#686890] hover:text-[#0D0D26] text-[13.5px] font-medium transition-colors mb-8"
        >
          <ChevronLeftIcon /> Back to blog
        </Link>
        {/* HERO SECTION */}
        <div className="max-w-225 mb-10">
          <div className="flex items-center gap-3 mb-5">
            <span className="bg-[#EEEDFC] text-[#4B4BDB] text-[12px] font-semibold px-3 py-1.5 rounded-sm uppercase tracking-wide">
          ...
          <div className="flex items-center gap-3 text-[#686890] text-[14px]">
            <span className="font-medium text-[#0D0D26]">
              {post.authorName}
            </span>
        ...
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-20 relative">
            ...
            <div className="mt-16 bg-[#1A1A4A] p-8 md:p-12 text-center md:text-left flex flex-col md:flex-row items-center justify-between gap-8 rounded-lg shadow-xl">
              <div className="max-w-100">
                ...
                <p className="text-[14px] text-[#BDBDD7] leading-[1.6]">
                  See how Wecollect handles address validation at scale across
                  Africa — GPS-verified, QA-clean, audit-ready.
                </p>
              </div>
              <Button
                href="/demo"
          ...
          <div className="w-full lg:w-100 shrink-0 flex flex-col divide-y divide-[#E9E9EF]">
            {/* Promo Box */}
            <div className="p-8 lg:p-10 border border-[#E9E9EF] border-b-0">
              <div className="bg-[#1A1A4A] p-6 rounded-lg text-white">
                ...
                <p className="text-[13px] text-[#BDBDD7] mb-6 leading-normal">
                  See Wecollect live against your specific use-case in 30
                  minutes
                </p>
                <Button
                  href="/demo"
              ...
              <div className="flex items-center gap-3">
                {[
                  ...
                  <button
                    ...
                    className="w-9 h-9 border border-[#E9E9EF] flex items-center justify-center text-[#9898B3] hover:text-[#4B4BDB] hover:border-[#4B4BDB] hover:bg-[#F0F0FF] transition-colors rounded-xs"
                  >
                    {social.icon}
                  </button>
                ))}
                ...
                {recentPosts.map((recentPost) => (
                  ...
                  >
                    <div className="relative w-full aspect-16/7 overflow-hidden bg-gray-100">
                      <Image
                        src={recentPost.image || BlogPlaceholder}
            ...
            <div className="p-8 lg:p-10 border border-[#E9E9EF] border-t-0">
              ...
              <p className="text-[11px] text-[#9898B3]">
                ...
                <Link
                  href="/privacy-policy"
                  className="text-[#4B4BDB] hover:underline"
                >
                  Privacy Policy
                </Link>
              </p>
